...
# Sobre o Projeto
O <strong>CyberThreatHub</strong> é uma plataforma desenvolvida no contexto da disciplina <strong>Projeto Integrador</strong>, do curso de <strong>Análise e Desenvolvimento de Sistemas</strong>.
...
A plataforma foi idealizada para apoiar analistas de Cyber Threat Intelligence (CTI) no monitoramento de ameaças e na análise de tendências relacionadas a ataques cibernéticos.
